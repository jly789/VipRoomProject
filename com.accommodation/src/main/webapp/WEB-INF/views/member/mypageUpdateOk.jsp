...
<%--          <span id="result"></span>--%>
        ...
        <h6 style="text-align: left">닉네임</h6>
        <div class="form-group">
        ...
        <h6 style="text-align: left">생일</h6>
        <div class="form-group">
        ...
        <h6 style="text-align: left">주소</h6>
        <div class="form-group">
        ...
        <h6 style="text-align: left">상세주소</h6>
        ...
        <h6 style="text-align: left">참고사항</h6>
